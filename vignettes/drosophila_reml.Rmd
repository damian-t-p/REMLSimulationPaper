...
This file creates plots for regular and bootstrapped eigenvalues stemming from the *Drosophila melanogaster* data.

The scripts for generating the bootstrapped resamples can be found in [[another file]] --- the code presended here simply loads the relevant data from the `data/` directory.
...
Plot the eigenvalues of the REML estimate of the raw *Drosophila melanogaster* data as it appears in [[the original study]].
